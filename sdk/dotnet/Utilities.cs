...
namespace Pulumi.Gotrue
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/supabase-community/pulumi-gotrue";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Gotrue.version.txt");
    ...
    internal sealed class GotrueResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GotrueResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
