...
import (
	...
	"github.com/supabase-community/pulumi-gotrue/provider/pkg/version"
...
const (
	...
	mainPkg = "gotrue"
	// modules:
	mainMod = "index" // the gotrue module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	p := shimv2.NewProvider(gotrue.Provider())
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"pulumi", "gotrue", "category/cloud"},
		License:    "MIT",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: filepath.Join(
				fmt.Sprintf("github.com/supabase-community/pulumi-%[1]s/sdk/", mainPkg),
