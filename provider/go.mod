module github.com/supabase-community/pulumi-gotrue/provider
...
replace github.com/supabase-community/terraform-provider-gotrue => /Users/cemalkilic/projects/terraform-provider-gotrue

require (
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.28.1
	github.com/pulumi/pulumi/sdk/v3 v3.38.0
	github.com/supabase-community/terraform-provider-gotrue v1.0.1
)
